...
readvar PARTITION_TABLE <<END_PARTITION_TABLE
  ...
  ${DISK}${DISK_SUFFIX}4: name="rootfs-A", size=  20120MiB, type=4F68BCE3-E8CD-4DB1-96E7-FBCAF984B709
  ${DISK}${DISK_SUFFIX}5: name="rootfs-B", size=  20120MiB, type=4F68BCE3-E8CD-4DB1-96E7-FBCAF984B709
  ${DISK}${DISK_SUFFIX}6: name="var-A",    size=   241MiB, type=4D21B016-B534-45C2-A9FB-5C16E091FD2D
  ${DISK}${DISK_SUFFIX}7: name="var-B",    size=   241MiB, type=4D21B016-B534-45C2-A9FB-5C16E091FD2D
